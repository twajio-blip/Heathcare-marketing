    ...
    container.innerHTML = resourceData.map((item, index) => {
        ...
        <a href="#"
            ...
            <div class="relative z-10">
              ...
              <div class="text-size-body inline-flex items-center px-medium py-1.5 rounded-xl bg-skin-primary/5 text-skin-primary text-size-accent font-black uppercase tracking-[0.25em] mb-large group-hover:bg-skin-primary group-hover:text-white transition-all duration-500 transform group-hover:translate-x-1">
                ${item.category}
              </div>
              
              <h3 class="text-size-body font-black text-skin-accent leading-tight mb-large group-hover:text-skin-primary transition-colors duration-300">
                ${item.title}
              </h3>
            ...
            <div class="relative z-10 mt-huge flex items-center justify-between border-t border-slate-100 pt-huge">
              <div class="flex items-center gap-small">
                <span class="text-size-xsmall font-bold text-skin-accent-4 uppercase tracking-widest">${item.date}</span>
                <span class="w-1.5 h-1.5 rounded-full bg-slate-200 group-hover:bg-skin-primary/30 transition-colors duration-300"></span>
                <span class="text-size-xsmall font-bold text-skin-accent-4 uppercase tracking-widest">${item.extraInfo}</span>
              </div>
